...
export function DashboardSidebar({ displayName, email }: Props) {
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-full max-w-[270px] flex-col justify-between border-r border-zinc-200 bg-white/80 p-4 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/70">
